...
export class colorLight extends dimmableLight {
    ...
    constructor(node: Node, config: any, _name: any = '') {
        ...
        const supportsCT = !!config.supportsColorTemperature;
        ...
        this.attributes = {
            ...
            colorControl: {
                ...
                // Default color mode required by Matter: 0=hue/sat, 1=xy, 2=ct
                // We default to XY to match default colorSpace
                colorMode: 1,
                colorCapabilities: {
                    hueSaturation: true,
                    xy: true,
        ...
        const features: any[] = ["EnhancedHue", "Xy", "HueSaturation"];
        if (supportsCT) features.push("ColorTemperature");
        this.withs.push(ColorControlServer.with(...features));
    ...
    override async preProcessNodeRedInput(item: any, value: any) {
        ...
        if (a === "color") {
            if (Object.hasOwn(b, "hue") && Object.hasOwn(b, "saturation")) {
                ...
                // ignore other color specs when CT is provided
                delete b.hue;
                delete b.saturation;
                delete b.colorX;
                delete b.colorY;
