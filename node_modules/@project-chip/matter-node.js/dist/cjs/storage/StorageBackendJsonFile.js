 ...
 */
class StorageBackendJsonFile extends import_storage.StorageBackendMemory {
  constructor(path) {
    super();
    this.path = path;
  }
  ...
  commitTimer = import_time.Time.getTimer(
    "Storage commit",
  ...
  toJson(object) {
    return (0, import_storage.toJson)(object, 1);
  }
  fromJson(json) {
    return (0, import_storage.fromJson)(json);
  }
}
