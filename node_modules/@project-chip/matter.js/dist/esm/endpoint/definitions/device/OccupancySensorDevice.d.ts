...
import { OccupancySensingServer as BaseOccupancySensingServer } from "../../../behavior/definitions/occupancy-sensing/OccupancySensingServer.js";
...
export declare const OccupancySensorDeviceDefinition: MutableEndpoint.With<import("../../type/EndpointType.js").EndpointType.For<{
    ...
    readonly behaviors: {
        ...
        readonly occupancySensing: typeof BaseOccupancySensingServer;
    };
}>, {
    readonly identify: typeof BaseIdentifyServer;
} & {
