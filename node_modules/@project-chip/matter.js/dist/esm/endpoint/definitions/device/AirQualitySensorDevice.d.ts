...
import { TemperatureMeasurementServer as BaseTemperatureMeasurementServer } from "../../../behavior/definitions/temperature-measurement/TemperatureMeasurementServer.js";
import { RelativeHumidityMeasurementServer as BaseRelativeHumidityMeasurementServer } from "../../../behavior/definitions/relative-humidity-measurement/RelativeHumidityMeasurementServer.js";
import { CarbonMonoxideConcentrationMeasurementServer as BaseCarbonMonoxideConcentrationMeasurementServer } from "../../../behavior/definitions/carbon-monoxide-concentration-measurement/CarbonMonoxideConcentrationMeasurementServer.js";
import { CarbonDioxideConcentrationMeasurementServer as BaseCarbonDioxideConcentrationMeasurementServer } from "../../../behavior/definitions/carbon-dioxide-concentration-measurement/CarbonDioxideConcentrationMeasurementServer.js";
import { NitrogenDioxideConcentrationMeasurementServer as BaseNitrogenDioxideConcentrationMeasurementServer } from "../../../behavior/definitions/nitrogen-dioxide-concentration-measurement/NitrogenDioxideConcentrationMeasurementServer.js";
import { OzoneConcentrationMeasurementServer as BaseOzoneConcentrationMeasurementServer } from "../../../behavior/definitions/ozone-concentration-measurement/OzoneConcentrationMeasurementServer.js";
import { FormaldehydeConcentrationMeasurementServer as BaseFormaldehydeConcentrationMeasurementServer } from "../../../behavior/definitions/formaldehyde-concentration-measurement/FormaldehydeConcentrationMeasurementServer.js";
import { Pm1ConcentrationMeasurementServer as BasePm1ConcentrationMeasurementServer } from "../../../behavior/definitions/pm1-concentration-measurement/Pm1ConcentrationMeasurementServer.js";
import { Pm25ConcentrationMeasurementServer as BasePm25ConcentrationMeasurementServer } from "../../../behavior/definitions/pm25-concentration-measurement/Pm25ConcentrationMeasurementServer.js";
import { Pm10ConcentrationMeasurementServer as BasePm10ConcentrationMeasurementServer } from "../../../behavior/definitions/pm10-concentration-measurement/Pm10ConcentrationMeasurementServer.js";
import { RadonConcentrationMeasurementServer as BaseRadonConcentrationMeasurementServer } from "../../../behavior/definitions/radon-concentration-measurement/RadonConcentrationMeasurementServer.js";
import { TotalVolatileOrganicCompoundsConcentrationMeasurementServer as BaseTotalVolatileOrganicCompoundsConcentrationMeasurementServer } from "../../../behavior/definitions/total-volatile-organic-compounds-concentration-measurement/TotalVolatileOrganicCompoundsConcentrationMeasurementServer.js";
...
export declare const AirQualitySensorDeviceDefinition: MutableEndpoint.With<import("../../type/EndpointType.js").EndpointType.For<{
