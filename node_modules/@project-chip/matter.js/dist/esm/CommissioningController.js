...
class CommissioningController extends MatterNode {
  ...
  async initializeController() {
    ...
    const environmentStore = environment !== void 0 ? environment.get(ControllerStore) : void 0;
    ...
    return await MatterController.create({
      ...
      nodesStorage,
      mdnsScanner,
      netInterfaceIpv4: this.ipv4Disabled ? void 0 : await UdpInterface.create(Network.get(), "udp4", localPort, this.listeningAddressIpv4),
