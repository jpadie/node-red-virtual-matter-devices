 ...
 */
export declare const ContentControlBehavior: ClusterBehavior.Type<ContentControl.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
