 ...
 */
export declare const PulseWidthModulationBehavior: ClusterBehavior.Type<PulseWidthModulation.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
...
export declare namespace PulseWidthModulationBehavior {
    interface State extends StateType {
    }
}
export {};
//# sourceMappingURL=PulseWidthModulationBehavior.d.ts.map