 ...
 */
export declare const SoftwareDiagnosticsBehavior: ClusterBehavior.Type<SoftwareDiagnostics.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
