 ...
 */
export declare const OtaSoftwareUpdateProviderBehavior: ClusterBehavior.Type<OtaSoftwareUpdateProvider.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
