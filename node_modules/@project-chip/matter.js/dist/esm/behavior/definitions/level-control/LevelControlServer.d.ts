...
declare const LevelControlLogicBase: import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/export.js").ClusterComposer.WithFeatures<LevelControl.Cluster, readonly [LevelControl.Feature.OnOff, LevelControl.Feature.Lighting]>, import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<LevelControl.Cluster, import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
    ...
    readonly commands: {};
    readonly events: {};
}>, typeof import("../../cluster/ClusterBehavior.js").ClusterBehavior, import("./LevelControlInterface.js").LevelControlInterface>, import("./LevelControlInterface.js").LevelControlInterface>, import("./LevelControlInterface.js").LevelControlInterface>;
/**
...
export declare namespace LevelControlServerLogic {
    ...
    const ExtensionInterface: {
        ...
        stepLogic(stepMode: LevelControl.StepMode, stepSize: number, transitionTime: number | null, withOnOff: boolean): MaybePromise<void>;
...
declare const LevelControlServer_base: import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/export.js").ClusterComposer.WithFeatures<import("../../../cluster/export.js").ClusterComposer.WithFeatures<LevelControl.Cluster, readonly [LevelControl.Feature.OnOff, LevelControl.Feature.Lighting]>, readonly [LevelControl.Feature.OnOff]>, typeof LevelControlServerLogic, import("./LevelControlInterface.js").LevelControlInterface>;
