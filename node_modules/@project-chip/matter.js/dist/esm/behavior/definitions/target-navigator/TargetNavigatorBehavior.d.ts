 ...
 */
export declare const TargetNavigatorBehavior: ClusterBehavior.Type<TargetNavigator.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
