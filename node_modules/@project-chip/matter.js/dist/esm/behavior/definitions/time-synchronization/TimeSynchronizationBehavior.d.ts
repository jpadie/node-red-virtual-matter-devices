 ...
 */
export declare const TimeSynchronizationBehavior: ClusterBehavior.Type<TimeSynchronization.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
