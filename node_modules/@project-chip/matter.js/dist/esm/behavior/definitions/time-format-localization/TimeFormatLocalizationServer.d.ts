...
declare const TimeFormatLocalizationServer_base: import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/export.js").ClusterComposer.WithFeatures<TimeFormatLocalization.Cluster, readonly ["CalendarFormat"]>, import("../../cluster/ClusterBehavior.js").ClusterBehavior.Type<TimeFormatLocalization.Cluster, typeof import("../../cluster/ClusterBehavior.js").ClusterBehavior, {
    components: never[];
}>, {
    components: never[];
}>;
