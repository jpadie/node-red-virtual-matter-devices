...
export declare const Transaction: {
     ...
     */
    ReadOnly: {
        "__#7040@#participants": Set<Participant>;
        "__#7040@#roles": Map<{}, Participant>;
        "__#7040@#resources": Set<Resource>;
        "__#7040@#status": Status;
        "__#7040@#waitingOn"?: Iterable<Transaction>;
        "__#7040@#via": string;
        "__#7040@#shared"?: import("../../../util/Observable.js").Observable<[]>;
        "__#7040@#closed"?: import("../../../util/Observable.js").Observable<[]>;
        close(): void;
        readonly via: string;
        readonly status: Status;
        readonly participants: Set<Participant>;
        ...
        waitFor(others: Set<Transaction>): Promise<void>;
        toString(): string;
        "__#7040@#finalize"(status: Status, why: string, finalizer: () => MaybePromise): Promise<void> | undefined;
        "__#7040@#executePreCommit"(): MaybePromise<void>;
        "__#7040@#executeCommit"(): MaybePromise;
        "__#7040@#executeCommit1"(): MaybePromise;
        "__#7040@#executeCommit2"(): Promise<void> | undefined;
        "__#7040@#executePostCommit"(participants: Participant[]): MaybePromise;
        "__#7040@#executeRollback"(): Promise<void> | undefined;
        "__#7040@#log"(...message: unknown[]): void;
        "__#7040@#locksChanged"(resources: Set<Resource>, how?: string): void;
        "__#7040@#assertAvailable"(): void;
    };
