 ...
 */
export type FieldValue = null | string | number | bigint | boolean | Date | FieldValue[] | FieldValue.Properties | FieldValue.Reference | FieldValue.Percent | FieldValue.Celsius | FieldValue.Bytes;
export declare namespace FieldValue {
     ...
     */
    type Type = percent | celsius | reference | properties | bytes;
    /**
    ...
    function Bytes(value: ByteArray | string): Bytes;
    /**
