...
export declare class ModelTraversal {
     ...
     */
    findChildren(scope: Model, tags: ElementTag[]): Model[];
    /**
     ...
     */
    findActiveMembers(scope: Model & {
        members: PropertyModel[];
    }, conformantOnly: boolean, cluster?: ClusterModel): ValueModel[];
    /**
