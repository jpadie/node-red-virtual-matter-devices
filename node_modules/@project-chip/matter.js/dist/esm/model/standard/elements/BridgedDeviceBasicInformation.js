...
const BridgedDeviceBasicInformation = Cluster({
  ...
  children: [
    ...
    Attribute({ name: "VendorName", id: 1, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "VendorId", id: 2, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "ProductName", id: 3, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "ProductId", id: 4, conformance: "X", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "NodeLabel", id: 5, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "Location", id: 6, conformance: "X", xref: { document: "core", section: "9.13.4" } }),
    Attribute({
    ...
    Attribute({ name: "PartNumber", id: 12, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "ProductUrl", id: 13, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "ProductLabel", id: 14, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "SerialNumber", id: 15, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({
    ...
    Attribute({ name: "Reachable", id: 17, conformance: "M", xref: { document: "core", section: "9.13.4" } }),
    Attribute({ name: "UniqueId", id: 18, conformance: "O", xref: { document: "core", section: "9.13.4" } }),
    Attribute({
    ...
    Event({
      ...
      children: [Field({ name: "FabricIndex", id: 0, conformance: "X" })]
    }),
    Event({
