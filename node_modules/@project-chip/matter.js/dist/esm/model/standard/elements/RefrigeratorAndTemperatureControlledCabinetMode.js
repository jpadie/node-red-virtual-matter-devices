...
const RefrigeratorAndTemperatureControlledCabinetMode = Cluster({
  ...
  children: [
    ...
    Attribute({ name: "CurrentMode", id: 1, conformance: "M", xref: { document: "cluster", section: "8.7.5" } }),
    Attribute({ name: "StartUpMode", id: 2, conformance: "P", xref: { document: "cluster", section: "8.7.5" } }),
    Attribute({ name: "OnMode", id: 3, conformance: "P", xref: { document: "cluster", section: "8.7.5" } }),
    Datatype({
