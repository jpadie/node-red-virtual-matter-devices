...
const logger = import_Logger.Logger.get("FailsafeTimer");
class FailsafeTimer {
  ...
  #startFailsafeTimer(expiryLengthSeconds) {
    return import_Time.Time.getTimer(
      "Failsafe expiration",
