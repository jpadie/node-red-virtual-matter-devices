  ...
  updatePartsList() {
    ...
    for (const child of this.childEndpoints) {
      ...
      if (child.number === void 0) {
        throw new import_MatterError.InternalError(`Child endpoint has no id, cannot add to parts list`);
      }
      newPartsList.push((0, import_EndpointNumber.EndpointNumber)(child.number));
