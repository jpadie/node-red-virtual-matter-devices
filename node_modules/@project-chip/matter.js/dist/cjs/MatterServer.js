...
class MatterServer {
  ...
  async start() {
    if (this.mdnsBroadcaster === void 0) {
      this.mdnsBroadcaster = await import_MdnsBroadcaster.MdnsBroadcaster.create(import_Network.Network.get(), {
    ...
    if (this.mdnsScanner === void 0) {
      this.mdnsScanner = await import_MdnsScanner.MdnsScanner.create(import_Network.Network.get(), {
        enableIpv4: !this.ipv4Disabled,
