...
class ArraySchema extends import_TlvSchema.TlvSchema {
  ...
  decodeTlvInternalValue(reader, typeLength) {
    ...
    while (true) {
      ...
      if (elementTag !== void 0) throw new import_MatterError.UnexpectedDataError("Array element tags should be anonymous.");
  ...
  validate(data) {
    ...
    if (data.length > this.maxLength)
      throw new import_ValidationError.ValidationOutOfBoundsError(
        `Array ${(0, import_String.serialize)(data)} is too long: ${data.length}, max ${this.maxLength}.`
      );
    if (data.length < this.minLength)
      throw new import_ValidationError.ValidationOutOfBoundsError(
        `Array ${(0, import_String.serialize)(data)} is too short: ${data.length}, min ${this.minLength}.`
      );
  ...
  decodeFromChunkedArray(chunks, currentValue) {
    ...
    currentValue = currentValue !== void 0 ? (0, import_DeepCopy.deepCopy)(currentValue) : [];
