...
export declare function decodeListAttributeValueWithSchema<T>(schema: TlvSchema<T>, values: TypeFromSchema<typeof TlvAttributeData>[], currentValue?: T): T | undefined;
