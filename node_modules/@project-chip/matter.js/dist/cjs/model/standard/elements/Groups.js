...
const Groups = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "NameSupport", constraint: "7", default: 1 })]
    }),
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "GroupId", id: 0, type: "group-id", conformance: "M", constraint: "min 1" })]
    }),
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({
        ...
        children: [(0, import_elements.FieldElement)({ name: "entry", type: "group-id" })]
      })]
    }),
    (0, import_elements.CommandElement)({
      name: "RemoveGroup",
...
import_Matter.Matter.children.push(Groups);
