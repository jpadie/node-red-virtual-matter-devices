...
const ValidProxies = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "ValidProxyStruct" })]
    }),
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({
        ...
        type: "list",
        conformance: "M",
        children: [(0, import_elements.FieldElement)({ name: "entry", type: "node-id" })]
      })]
    }),
    (0, import_elements.DatatypeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "NodeId", id: 1, type: "node-id", access: "RW", conformance: "M" })]
    })
  ]
});
import_Matter.Matter.children.push(ValidProxies);
