...
const EnergyPreference = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "BalanceStruct" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "EnergyPriorityEnum" })]
    }),
    (0, import_elements.AttributeElement)({
...
import_Matter.Matter.children.push(EnergyPreference);
