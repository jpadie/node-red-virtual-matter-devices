...
const ThermostatDt = (0, import_elements.DeviceTypeElement)({
  ...
  children: [
    (0, import_elements.RequirementElement)({
      ...
      children: [(0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 769, revision: 3 }], element: "attribute" })]
    }),
    (0, import_elements.RequirementElement)({
      name: "Identify",
      id: 3,
...
import_Matter.Matter.children.push(ThermostatDt);
