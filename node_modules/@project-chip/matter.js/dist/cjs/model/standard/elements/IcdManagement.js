...
const IcdManagement = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "MonitoringRegistrationStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "IcdCounter",
      id: 4,
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "IcdCounter", id: 0, type: "uint32", conformance: "M" })]
    }),
    (0, import_elements.CommandElement)({
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "StayActiveDuration", id: 0, type: "uint32", conformance: "M" })]
    }),
    (0, import_elements.CommandElement)({
...
import_Matter.Matter.children.push(IcdManagement);
