...
const BooleanStateConfiguration = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.DatatypeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "GeneralFault", constraint: "0", description: "Unspecified fault detected" })]
    })
  ]
});
import_Matter.Matter.children.push(BooleanStateConfiguration);
