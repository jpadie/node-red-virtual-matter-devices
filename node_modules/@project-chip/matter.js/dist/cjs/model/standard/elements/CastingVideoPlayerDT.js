...
const CastingVideoPlayerDt = (0, import_elements.DeviceTypeElement)({
  ...
  children: [
    ...
    (0, import_elements.RequirementElement)({
      ...
      element: "serverCluster",
      xref: { document: "device", section: "10.3.4" },
      children: [(0, import_elements.RequirementElement)({ name: "APPLICATIONPLATFORM", conformance: "M", element: "feature" })]
    }),
    (0, import_elements.RequirementElement)({
      name: "AccountLogin",
      id: 1294,
...
import_Matter.Matter.children.push(CastingVideoPlayerDt);
