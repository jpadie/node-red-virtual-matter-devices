...
const Thermostat = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [
        ...
        (0, import_elements.FieldElement)({
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "WeeklyScheduleTransitionStruct" })]
        })
      ]
    }),
    (0, import_elements.CommandElement)({
    ...
    (0, import_elements.DatatypeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "BtUh", id: 0, conformance: "O", description: "British Thermal Unit per Hour" })]
    }),
    (0, import_elements.DatatypeElement)({
...
import_Matter.Matter.children.push(Thermostat);
