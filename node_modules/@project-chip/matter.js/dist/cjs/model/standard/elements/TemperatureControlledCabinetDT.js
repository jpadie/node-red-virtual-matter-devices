...
const TemperatureControlledCabinetDt = (0, import_elements.DeviceTypeElement)({
  ...
  children: [
    (0, import_elements.RequirementElement)({
      ...
      children: [(0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 113, revision: 2 }], element: "attribute" })]
    }),
    (0, import_elements.RequirementElement)({
...
import_Matter.Matter.children.push(TemperatureControlledCabinetDt);
