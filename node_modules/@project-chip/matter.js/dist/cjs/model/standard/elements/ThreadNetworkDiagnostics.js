...
const ThreadNetworkDiagnostics = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "NeighborTableStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "RouteTable",
      id: 8,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "RouteTableStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "PartitionId",
      id: 9,
    ...
    (0, import_elements.EventElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "ConnectionStatus", id: 0, type: "ConnectionStatusEnum", conformance: "M" })]
    }),
    (0, import_elements.EventElement)({
...
import_Matter.Matter.children.push(ThreadNetworkDiagnostics);
