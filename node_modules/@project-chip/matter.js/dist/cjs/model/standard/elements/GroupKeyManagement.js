...
const GroupKeyManagement = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "GroupKeyMapStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "GroupTable",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "GroupInfoMapStruct" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "GroupKeySet", id: 0, type: "GroupKeySetStruct", conformance: "M" })]
    }),
    (0, import_elements.CommandElement)({
      name: "KeySetRead",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "GroupKeySetId", id: 0, type: "uint16", conformance: "M" })]
    }),
    (0, import_elements.CommandElement)({
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({
        ...
        children: [(0, import_elements.FieldElement)({ name: "entry", type: "uint16" })]
      })]
    }),
    ...
    (0, import_elements.DatatypeElement)({
      ...
      children: [
        ...
        (0, import_elements.FieldElement)({
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "endpoint-no" })]
        }),
        (0, import_elements.FieldElement)({
          name: "GroupName",
          id: 3,
...
import_Matter.Matter.children.push(GroupKeyManagement);
