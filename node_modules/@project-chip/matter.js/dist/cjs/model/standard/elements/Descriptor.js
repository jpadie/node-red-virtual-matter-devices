...
const Descriptor = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "DeviceTypeStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "ServerList",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "cluster-id" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "ClientList",
      id: 2,
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "semtag" })]
    }),
...
import_Matter.Matter.children.push(Descriptor);
