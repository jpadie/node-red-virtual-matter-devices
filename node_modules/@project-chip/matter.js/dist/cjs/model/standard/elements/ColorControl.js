...
const ColorControl = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "ExecuteIfOff", constraint: "0" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "Inactive", id: 0 }), (0, import_elements.FieldElement)({ name: "Active", id: 1 })]
    }),
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "Decrement", id: 0 }), (0, import_elements.FieldElement)({ name: "Increment", id: 1 })]
    }),
    (0, import_elements.AttributeElement)({
      name: "ColorLoopTime",
      id: 16388,
    ...
    (0, import_elements.DatatypeElement)({
      ...
      type: "enum8",
      xref: { document: "cluster", section: "3.2.11.6.1" },
      children: [(0, import_elements.FieldElement)({ name: "Up", id: 1 }), (0, import_elements.FieldElement)({ name: "Down", id: 3 })]
    }),
    (0, import_elements.DatatypeElement)({
      name: "Direction",
      type: "enum8",
...
import_Matter.Matter.children.push(ColorControl);
