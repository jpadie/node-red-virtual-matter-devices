...
const Messages = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "MessageStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "MessageID" })]
    }),
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [
        ...
        (0, import_elements.FieldElement)({
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "MessageResponseOptionStruct" })]
        })
      ]
    }),
    (0, import_elements.CommandElement)({
...
import_Matter.Matter.children.push(Messages);
