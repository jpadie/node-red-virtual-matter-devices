...
const DeviceEnergyManagementDt = (0, import_elements.DeviceTypeElement)({
  ...
  children: [
    (0, import_elements.RequirementElement)({
      ...
      children: [(0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 1293, revision: 1 }], element: "attribute" })]
    }),
    (0, import_elements.RequirementElement)({
      name: "DeviceEnergyManagement",
      id: 152,
...
import_Matter.Matter.children.push(DeviceEnergyManagementDt);
