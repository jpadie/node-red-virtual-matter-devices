...
const PowerSource = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "WiredFaultEnum" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "BatVoltage",
      id: 11,
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "BatFaultEnum" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "BatChargeFaultEnum" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "EndpointList",
      id: 31,
...
import_Matter.Matter.children.push(PowerSource);
