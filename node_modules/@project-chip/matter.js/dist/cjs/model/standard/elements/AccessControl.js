...
const AccessControl = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "AccessControlEntryStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "Extension",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "AccessControlExtensionStruct" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.DatatypeElement)({
      ...
      children: [
        ...
        (0, import_elements.FieldElement)({
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "subject-id" })]
        }),
        (0, import_elements.FieldElement)({
          name: "Targets",
          id: 4,
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "AccessControlTargetStruct" })]
        }),
        (0, import_elements.FieldElement)({ name: "FabricIndex", id: 254, type: "FabricIndex" })
      ]
    }),
...
import_Matter.Matter.children.push(AccessControl);
