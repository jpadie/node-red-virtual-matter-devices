...
const MicrowaveOvenDt = (0, import_elements.DeviceTypeElement)({
  ...
  children: [
    (0, import_elements.RequirementElement)({
      ...
      children: [(0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 121, revision: 1 }], element: "attribute" })]
    }),
    (0, import_elements.RequirementElement)({
      name: "Identify",
      id: 3,
    ...
    (0, import_elements.RequirementElement)({
      ...
      element: "serverCluster",
      xref: { document: "device", section: "13.11.6" },
      children: [(0, import_elements.RequirementElement)({ name: "CountdownTime", conformance: "M", element: "attribute" })]
    }),
    (0, import_elements.RequirementElement)({
      name: "FanControl",
      id: 514,
...
import_Matter.Matter.children.push(MicrowaveOvenDt);
