...
const ContentControl = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "RatingNameStruct" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "BlockChannelStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "AppInfoStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "TimeWindowStruct" })]
    }),
    ...
    (0, import_elements.DatatypeElement)({
      ...
      children: [
        ...
        (0, import_elements.FieldElement)({
          ...
          children: [(0, import_elements.FieldElement)({ name: "entry", type: "TimePeriodStruct" })]
        })
      ]
    }),
    (0, import_elements.DatatypeElement)({
...
import_Matter.Matter.children.push(ContentControl);
