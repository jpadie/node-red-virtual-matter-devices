...
const ElectricalPowerMeasurement = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "MeasurementAccuracyStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "Ranges",
      id: 3,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "MeasurementRangeStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "Voltage",
      id: 4,
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "HarmonicMeasurementStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "HarmonicPhases",
      id: 16,
...
import_Matter.Matter.children.push(ElectricalPowerMeasurement);
