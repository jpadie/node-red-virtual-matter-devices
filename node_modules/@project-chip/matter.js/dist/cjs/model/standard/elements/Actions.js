...
const Actions = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "ActionStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "EndpointLists",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "EndpointListStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "SetupUrl",
      id: 2,
...
import_Matter.Matter.children.push(Actions);
