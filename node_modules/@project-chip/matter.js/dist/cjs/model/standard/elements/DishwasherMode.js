...
var DishwasherMode_exports = {};
__export(DishwasherMode_exports, {
  DishwasherMode: () => DishwasherMode
});
module.exports = __toCommonJS(DishwasherMode_exports);
...
const DishwasherMode = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({ name: "CurrentMode", id: 1, conformance: "M", xref: { document: "cluster", section: "8.3.5" } }),
    (0, import_elements.AttributeElement)({
      name: "StartUpMode",
      id: 2,
      conformance: "P",
    ...
    (0, import_elements.AttributeElement)({ name: "OnMode", id: 3, conformance: "P", xref: { document: "cluster", section: "8.3.5" } }),
...
import_Matter.Matter.children.push(DishwasherMode);
