...
const OperationalCredentials = (0, import_elements.ClusterElement)({
  ...
  children: [
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "NOCStruct" })]
    }),
    (0, import_elements.AttributeElement)({
      name: "Fabrics",
      id: 1,
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "FabricDescriptorStruct" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.AttributeElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "entry", type: "octstr" })]
    }),
    (0, import_elements.AttributeElement)({
    ...
    (0, import_elements.CommandElement)({
      ...
      children: [(0, import_elements.FieldElement)({ name: "AttestationNonce", id: 0, type: "octstr", conformance: "M", constraint: "32" })]
    }),
    (0, import_elements.CommandElement)({
...
import_Matter.Matter.children.push(OperationalCredentials);
