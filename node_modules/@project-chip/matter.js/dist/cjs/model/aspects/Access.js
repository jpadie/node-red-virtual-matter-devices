...
class Access extends import_Aspect.Aspect {
  ...
  constructor(definition) {
    ...
    } else if ((0, import_Type.isObject)(definition)) {
...
((Access2) => {
  ...
  Access2.PrivilegeLevel = {
    V: import_Cluster.AccessLevel.View,
    // 2 is ProxyView, seems not in use/model right now
    O: import_Cluster.AccessLevel.Operate,
    M: import_Cluster.AccessLevel.Manage,
    A: import_Cluster.AccessLevel.Administer
  };
  let Timed;
  ((Timed2) => {
    Timed2["Required"] = "T";
