...
class Constraint extends import_Aspect.Aspect {
  ...
  test(value, properties) {
    function valueOf(value2, raw = false) {
      ...
      if ((0, import_Type.isObject)(value2)) {
        const { type, name } = value2;
        if (type === import_definitions.FieldValue.reference && typeof name === "string") {
          value2 = valueOf(properties?.[(0, import_String.camelize)(name)], raw);
        }
      }
      return value2;
    }
...
((Constraint2) => {
  ...
  function serializeAtom(ast) {
    ...
    if (ast.in !== void 0) {
      return `in ${import_definitions.FieldValue.serialize(ast.in)}`;
    }
    return "all";
  }
