...
function IllegalFeatureCombinations(cluster) {
  ...
  function add(flags) {
    if (!illegal.some((e) => (0, import_DeepEqual.isDeepEqual)(e, flags))) {
      illegal.push(flags);
    }
  }
...
function addFeatureNode(feature, node, illegal, choices) {
  function unsupported() {
    throw new import_MatterError.InternalError(`New rule required to support ${feature.path} conformance "${feature.conformance}"`);
  }
