...
((FieldValue2) => {
  ...
  function Bytes(value) {
    return { type: FieldValue2.bytes, value: ArrayBuffer.isView(value) ? value.toHex() : value };
  }
  FieldValue2.Bytes = Bytes;
  function serialize(value) {
    ...
    if (is(value, FieldValue2.properties)) {
      return (0, import_String.serialize)(value.properties) ?? "?";
    }
  ...
  function unwrap(value, typeName) {
    ...
    switch (type) {
      ...
      case void 0:
        throw new import_MatterError.UnexpectedDataError(`Field value objects must be wrappers with "type" field`);
      default:
        throw new import_MatterError.UnexpectedDataError(`Unsupported wrapped object type "${type}"`);
    }
  }
