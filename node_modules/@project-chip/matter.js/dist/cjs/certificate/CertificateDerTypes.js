...
var CertificateDerTypes_exports = {};
__export(CertificateDerTypes_exports, {
  Pkcs7: () => Pkcs7,
...
module.exports = __toCommonJS(CertificateDerTypes_exports);
    ...
    values.forEach((value) => {
      switch (value) {
        ...
        case 6:
          ...
          break;
        default:
          throw new import_CertificateManager.CertificateError(`Unsupported extended key usage value ${value}`);
      }
    });
...
//# sourceMappingURL=CertificateDerTypes.js.map
