...
export declare namespace X962 {
    const PublicKeyEcPrime256v1: (key: ByteArray) => {
        type: {
            algorithm: {
                _tag: number;
                _bytes: Uint8Array;
...
export declare namespace X509 {
    const SubjectKeyIdentifier: (identifier: ByteArray) => any;
    const AuthorityKeyIdentifier: (identifier: ByteArray) => any;
...
//# sourceMappingURL=CertificateDerTypes.d.ts.map