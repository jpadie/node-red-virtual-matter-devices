...
var ContentLauncherCluster_exports = {};
__export(ContentLauncherCluster_exports, {
  ContentLauncher: () => ContentLauncher,
  ContentLauncherCluster: () => ContentLauncherCluster
});
module.exports = __toCommonJS(ContentLauncherCluster_exports);
...
((ContentLauncher2) => {
  ...
  let ParameterEnum;
  ((ParameterEnum2) => {
    ParameterEnum2[ParameterEnum2["Actor"] = 0] = "Actor";
    ParameterEnum2[ParameterEnum2["Channel"] = 1] = "Channel";
    ParameterEnum2[ParameterEnum2["Character"] = 2] = "Character";
    ParameterEnum2[ParameterEnum2["Director"] = 3] = "Director";
    ParameterEnum2[ParameterEnum2["Event"] = 4] = "Event";
    ParameterEnum2[ParameterEnum2["Franchise"] = 5] = "Franchise";
    ParameterEnum2[ParameterEnum2["Genre"] = 6] = "Genre";
    ParameterEnum2[ParameterEnum2["League"] = 7] = "League";
    ParameterEnum2[ParameterEnum2["Popularity"] = 8] = "Popularity";
    ParameterEnum2[ParameterEnum2["Provider"] = 9] = "Provider";
    ParameterEnum2[ParameterEnum2["Sport"] = 10] = "Sport";
    ParameterEnum2[ParameterEnum2["SportsTeam"] = 11] = "SportsTeam";
    ParameterEnum2[ParameterEnum2["Type"] = 12] = "Type";
    ParameterEnum2[ParameterEnum2["Video"] = 13] = "Video";
    ParameterEnum2[ParameterEnum2["Season"] = 14] = "Season";
    ParameterEnum2[ParameterEnum2["Episode"] = 15] = "Episode";
    ParameterEnum2[ParameterEnum2["Any"] = 16] = "Any";
  })(ParameterEnum = ContentLauncher2.ParameterEnum || (ContentLauncher2.ParameterEnum = {}));
  ...
  ContentLauncher2.TlvParameter = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ContentLauncher2.TlvContentSearch = (0, import_TlvObject.TlvObject)({
     ...
     */
    parameterList: (0, import_TlvObject.TlvField)(0, (0, import_TlvArray.TlvArray)(ContentLauncher2.TlvParameter))
  });
...
//# sourceMappingURL=ContentLauncherCluster.js.map
