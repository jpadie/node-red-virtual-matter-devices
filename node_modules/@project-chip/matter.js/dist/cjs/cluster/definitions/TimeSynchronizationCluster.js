...
var TimeSynchronizationCluster_exports = {};
__export(TimeSynchronizationCluster_exports, {
  TimeSynchronization: () => TimeSynchronization,
  TimeSynchronizationCluster: () => TimeSynchronizationCluster
});
module.exports = __toCommonJS(TimeSynchronizationCluster_exports);
...
((TimeSynchronization2) => {
  ...
  TimeSynchronization2.TimeZoneComponent = import_MutableCluster.MutableCluster.Component({
    ...
    commands: {
       ...
       */
      setDstOffset: (0, import_Cluster.Command)(4, TimeSynchronization2.TlvSetDstOffsetRequest, 4, import_Cluster.TlvNoResponse, { invokeAcl: import_Cluster.AccessLevel.Manage })
    },
    events: {
      /**
  ...
  TimeSynchronization2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    commands: {
       ...
       */
      setUtcTime: (0, import_Cluster.Command)(0, TimeSynchronization2.TlvSetUtcTimeRequest, 0, import_Cluster.TlvNoResponse, { invokeAcl: import_Cluster.AccessLevel.Administer })
    },
    events: {
      /**
...
//# sourceMappingURL=TimeSynchronizationCluster.js.map
