...
var OccupancySensingCluster_exports = {};
__export(OccupancySensingCluster_exports, {
  OccupancySensing: () => OccupancySensing,
  OccupancySensingCluster: () => OccupancySensingCluster
});
module.exports = __toCommonJS(OccupancySensingCluster_exports);
  ...
  OccupancySensing2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    attributes: {
      ...
      pirUnoccupiedToOccupiedThreshold: (0, import_Cluster.OptionalWritableAttribute)(
        ...
        { default: 1, writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
...
//# sourceMappingURL=OccupancySensingCluster.js.map
