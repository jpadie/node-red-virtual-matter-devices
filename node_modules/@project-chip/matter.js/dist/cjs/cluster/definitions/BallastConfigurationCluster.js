...
var BallastConfigurationCluster_exports = {};
__export(BallastConfigurationCluster_exports, {
  BallastConfiguration: () => BallastConfiguration,
  BallastConfigurationCluster: () => BallastConfigurationCluster
});
module.exports = __toCommonJS(BallastConfigurationCluster_exports);
...
((BallastConfiguration2) => {
  ...
  BallastConfiguration2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    attributes: {
       ...
       */
      minLevel: (0, import_Cluster.WritableAttribute)(16, import_TlvNumber.TlvUInt8, { writeAcl: import_Cluster.AccessLevel.Manage }),
      /**
       ...
       */
      maxLevel: (0, import_Cluster.WritableAttribute)(17, import_TlvNumber.TlvUInt8, { writeAcl: import_Cluster.AccessLevel.Manage }),
      /**
      ...
      ballastFactorAdjustment: (0, import_Cluster.OptionalWritableAttribute)(
        ...
        { default: null, writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
      ...
      lampType: (0, import_Cluster.OptionalWritableAttribute)(
        ...
        { default: "", writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
      ...
      lampBurnHours: (0, import_Cluster.OptionalWritableAttribute)(
        51,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt24),
        { default: 0, writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
