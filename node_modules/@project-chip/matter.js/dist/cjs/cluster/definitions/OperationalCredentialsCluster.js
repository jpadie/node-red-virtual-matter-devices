...
((OperationalCredentials2) => {
  ...
  OperationalCredentials2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    commands: {
       ...
       */
      csrRequest: (0, import_Cluster.Command)(4, OperationalCredentials2.TlvCsrRequest, 5, OperationalCredentials2.TlvCsrResponse, { invokeAcl: import_Cluster.AccessLevel.Administer }),
      /**
