...
var IcdManagementCluster_exports = {};
__export(IcdManagementCluster_exports, {
  IcdManagement: () => IcdManagement,
  IcdManagementCluster: () => IcdManagementCluster
});
module.exports = __toCommonJS(IcdManagementCluster_exports);
  ...
  IcdManagement2.CheckInProtocolSupportComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
      ...
      registeredClients: (0, import_Cluster.FabricScopedAttribute)(
        ...
        { persistent: true, default: [], readAcl: import_Cluster.AccessLevel.Administer, writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
...
//# sourceMappingURL=IcdManagementCluster.js.map
