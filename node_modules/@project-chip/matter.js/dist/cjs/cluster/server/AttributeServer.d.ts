 ...
 */
export declare function createAttributeServer<T, F extends BitSchema, SF extends TypeFromPartialBitSchema<F>, A extends Attributes, C extends Commands, E extends Events>(clusterDef: Cluster<F, SF, A, C, E>, attributeDef: Attribute<T, F>, attributeName: string, initValue: T, datasource: ClusterDatasource, getter?: (session?: Session<MatterDevice>, endpoint?: EndpointInterface, isFabricFiltered?: boolean, message?: Message) => T, setter?: (value: T, session?: Session<MatterDevice>, endpoint?: EndpointInterface, message?: Message) => boolean, validator?: (value: T, session?: Session<MatterDevice>, endpoint?: EndpointInterface) => void): FixedAttributeServer<T>;
/**
...
export declare class FixedAttributeServer<T> extends BaseAttributeServer<T> {
    ...
    protected readonly getter: (session?: Session<MatterDevice>, endpoint?: EndpointInterface, isFabricFiltered?: boolean, message?: Message) => T;
...
export declare class AttributeServer<T> extends FixedAttributeServer<T> {
    ...
    constructor(id: AttributeId, name: string, readAcl: AccessLevel | undefined, writeAcl: AccessLevel | undefined, schema: TlvSchema<T>, isWritable: boolean, isSubscribable: boolean, requiresTimedInteraction: boolean, initValue: T, defaultValue: T | undefined, datasource: ClusterDatasource, getter?: (session?: Session<MatterDevice>, endpoint?: EndpointInterface, isFabricFiltered?: boolean, message?: Message) => T, 
    /**
     ...
     */
    set(value: T, session: Session<MatterDevice>, message?: Message, delayChangeEvents?: boolean): void;
    /**
     * Method that contains the logic to set a value "from remote" (e.g. from a client).
     */
    protected setRemote(value: T, session: Session<MatterDevice>, message?: Message, delayChangeEvents?: boolean): void;
    /**
     ...
     */
    protected processSet(value: T, session?: Session<MatterDevice>, message?: Message, delayChangeEvents?: boolean): void;
     ...
     */
    updated(session: SecureSession<MatterDevice>): void;
    /**
...
export declare function genericFabricScopedAttributeGetter<T>(session: Session<MatterDevice> | undefined, isFabricFiltered: boolean, cluster: Cluster<any, any, any, any, any>, attributeName: string, defaultValue: T): T;
...
export declare function genericFabricScopedAttributeSetter<T>(value: T, session: Session<MatterDevice> | undefined, cluster: Cluster<any, any, any, any, any>, attributeName: string, defaultValue?: T): boolean;
/**
...
export declare class FabricScopedAttributeServer<T> extends AttributeServer<T> {
     ...
     */
    set(value: T, session: Session<MatterDevice>, message: Message, delayChangeEvents?: boolean, preserveFabricIndex?: boolean): void;
    /**
     ...
     */
    protected setRemote(value: T, session: Session<MatterDevice>, message: Message, delayChangeEvents?: boolean, preserveFabricIndex?: boolean): void;
    /**
