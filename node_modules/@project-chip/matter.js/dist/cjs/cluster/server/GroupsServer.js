...
class GroupsManager {
  static async setGroup(fabric, endpointId, groupId, groupName) {
    ...
    await fabric.setScopedClusterDataValue(import_GroupsCluster.GroupsCluster, endpointId.toString(), endpointGroups);
  }
  ...
  static async removeAllGroups(fabric, endpointId) {
    await fabric.deleteScopedClusterDataValue(import_GroupsCluster.GroupsCluster, endpointId.toString());
  }
}
