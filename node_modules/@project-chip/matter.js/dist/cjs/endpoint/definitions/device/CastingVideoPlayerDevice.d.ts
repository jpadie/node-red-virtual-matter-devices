...
import { MediaPlaybackServer as BaseMediaPlaybackServer } from "../../../behavior/definitions/media-playback/MediaPlaybackServer.js";
import { KeypadInputServer as BaseKeypadInputServer } from "../../../behavior/definitions/keypad-input/KeypadInputServer.js";
import { ContentLauncherServer as BaseContentLauncherServer } from "../../../behavior/definitions/content-launcher/ContentLauncherServer.js";
...
import { TargetNavigatorServer as BaseTargetNavigatorServer } from "../../../behavior/definitions/target-navigator/TargetNavigatorServer.js";
...
import { AudioOutputServer as BaseAudioOutputServer } from "../../../behavior/definitions/audio-output/AudioOutputServer.js";
import { ApplicationLauncherServer as BaseApplicationLauncherServer } from "../../../behavior/definitions/application-launcher/ApplicationLauncherServer.js";
import { AccountLoginServer as BaseAccountLoginServer } from "../../../behavior/definitions/account-login/AccountLoginServer.js";
import { ContentControlServer as BaseContentControlServer } from "../../../behavior/definitions/content-control/ContentControlServer.js";
...
export declare namespace CastingVideoPlayerRequirements {
     ...
     */
    const ApplicationLauncherServer: import("../../../behavior/cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/export.js").ClusterComposer.WithFeatures<import("../../../cluster/export.js").ApplicationLauncher.Cluster, readonly ["ApplicationPlatform"]>, typeof BaseApplicationLauncherServer, import("../../../behavior/definitions/application-launcher/ApplicationLauncherInterface.js").ApplicationLauncherInterface>;
    /**
    ...
    const server: {
        ...
        optional: {
            ...
            ApplicationLauncher: import("../../../behavior/cluster/ClusterBehavior.js").ClusterBehavior.Type<import("../../../cluster/export.js").ClusterComposer.WithFeatures<import("../../../cluster/export.js").ApplicationLauncher.Cluster, readonly ["ApplicationPlatform"]>, typeof BaseApplicationLauncherServer, import("../../../behavior/definitions/application-launcher/ApplicationLauncherInterface.js").ApplicationLauncherInterface>;
...
export declare const CastingVideoPlayerDeviceDefinition: MutableEndpoint.With<import("../../type/EndpointType.js").EndpointType.For<{
