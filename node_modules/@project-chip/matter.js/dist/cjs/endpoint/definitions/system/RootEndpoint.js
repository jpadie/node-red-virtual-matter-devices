...
var import_GroupKeyManagementServer = require("../../../behavior/definitions/group-key-management/GroupKeyManagementServer.js");
var import_GeneralCommissioningServer = require("../../../behavior/definitions/general-commissioning/GeneralCommissioningServer.js");
var import_AdministratorCommissioningServer = require("../../../behavior/definitions/administrator-commissioning/AdministratorCommissioningServer.js");
var import_OperationalCredentialsServer = require("../../../behavior/definitions/operational-credentials/OperationalCredentialsServer.js");
var import_GeneralDiagnosticsServer = require("../../../behavior/definitions/general-diagnostics/GeneralDiagnosticsServer.js");
var import_PowerSourceConfigurationServer = require("../../../behavior/definitions/power-source-configuration/PowerSourceConfigurationServer.js");
var import_TimeSynchronizationServer = require("../../../behavior/definitions/time-synchronization/TimeSynchronizationServer.js");
var import_NetworkCommissioningServer = require("../../../behavior/definitions/network-commissioning/NetworkCommissioningServer.js");
var import_LocalizationConfigurationServer = require("../../../behavior/definitions/localization-configuration/LocalizationConfigurationServer.js");
var import_TimeFormatLocalizationServer = require("../../../behavior/definitions/time-format-localization/TimeFormatLocalizationServer.js");
var import_UnitLocalizationServer = require("../../../behavior/definitions/unit-localization/UnitLocalizationServer.js");
var import_DiagnosticLogsServer = require("../../../behavior/definitions/diagnostic-logs/DiagnosticLogsServer.js");
var import_SoftwareDiagnosticsServer = require("../../../behavior/definitions/software-diagnostics/SoftwareDiagnosticsServer.js");
var import_EthernetNetworkDiagnosticsServer = require("../../../behavior/definitions/ethernet-network-diagnostics/EthernetNetworkDiagnosticsServer.js");
var import_WiFiNetworkDiagnosticsServer = require("../../../behavior/definitions/wi-fi-network-diagnostics/WiFiNetworkDiagnosticsServer.js");
var import_ThreadNetworkDiagnosticsServer = require("../../../behavior/definitions/thread-network-diagnostics/ThreadNetworkDiagnosticsServer.js");
var import_IcdManagementServer = require("../../../behavior/definitions/icd-management/IcdManagementServer.js");
var import_MutableEndpoint = require("../../type/MutableEndpoint.js");
var import_DeviceTypes = require("../../../device/DeviceTypes.js");
...
const RootEndpointDefinition = (0, import_MutableEndpoint.MutableEndpoint)({
  ...
  deviceType: 22,
  deviceRevision: 2,
  deviceClass: import_DeviceTypes.DeviceClasses.Node,
