...
class Crypto {
  ...
  static getRandomUInt16 = () => new import_DataReader.DataReader(Crypto.get().getRandomData(2), import_ByteArray.Endian.Little).readUInt16();
  static getRandomUInt32 = () => new import_DataReader.DataReader(Crypto.get().getRandomData(4), import_ByteArray.Endian.Little).readUInt32();
  static getRandomBigUInt64 = () => new import_DataReader.DataReader(Crypto.get().getRandomData(8), import_ByteArray.Endian.Little).readUInt64();
