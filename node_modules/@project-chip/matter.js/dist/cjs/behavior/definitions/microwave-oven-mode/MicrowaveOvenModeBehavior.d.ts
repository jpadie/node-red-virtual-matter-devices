 ...
 */
export declare const MicrowaveOvenModeBehavior: ClusterBehavior.Type<MicrowaveOvenMode.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
