 ...
 */
export declare const WiFiNetworkDiagnosticsBehavior: ClusterBehavior.Type<WiFiNetworkDiagnostics.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
