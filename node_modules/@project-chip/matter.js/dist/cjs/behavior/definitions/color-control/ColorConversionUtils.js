...
function hsvToXy(hue, saturation) {
  ...
  return [(0, import_Number.cropValueRange)(x, 0, 1), (0, import_Number.cropValueRange)(y, 0, 1)];
}
...
function miredsToXy(mireds) {
  ...
  const detailedValue = (0, import_kelvinToXy.kelvinToXyLookup)(Math.round(kelvin));
