 ...
 */
export declare const ProxyDiscoveryBehavior: ClusterBehavior.Type<ProxyDiscovery.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
