...
class IdentifyServer extends import_IdentifyBehavior.IdentifyBehavior {
  initialize() {
    if (this.state.identifyType === void 0) {
      this.state.identifyType = import_IdentifyCluster.Identify.IdentifyType.None;
    }
    this.internal.identifyTimer = import_Time.Time.getPeriodicTimer(
...
((IdentifyServer2) => {
  ...
  class Events extends import_IdentifyBehavior.IdentifyBehavior.Events {
    startIdentifying = (0, import_Observable.Observable)();
    stopIdentifying = (0, import_Observable.Observable)();
  }
