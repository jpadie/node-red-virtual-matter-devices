 ...
 */
export declare const IcdManagementBehavior: ClusterBehavior.Type<IcdManagement.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
