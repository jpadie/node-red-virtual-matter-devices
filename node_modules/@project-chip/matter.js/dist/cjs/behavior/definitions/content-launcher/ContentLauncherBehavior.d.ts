 ...
 */
export declare const ContentLauncherBehavior: ClusterBehavior.Type<ContentLauncher.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
