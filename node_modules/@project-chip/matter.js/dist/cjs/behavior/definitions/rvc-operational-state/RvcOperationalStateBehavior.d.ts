 ...
 */
export declare const RvcOperationalStateBehavior: ClusterBehavior.Type<RvcOperationalState.Cluster, ClusterBehavior.Type<import("../../../cluster/ClusterType.js").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
