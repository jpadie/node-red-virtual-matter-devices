...
export declare class IndexBehavior extends Behavior {
    ...
    get partsById(): Record<string, Endpoint<import("../../../endpoint/type/EndpointType.js").EndpointType.Empty> | undefined>;
    get partsByNumber(): Record<number, Endpoint<import("../../../endpoint/type/EndpointType.js").EndpointType.Empty> | undefined>;
    /**
     ...
     * matches.
     */
    forNumber(number: number): Endpoint<import("../../../endpoint/type/EndpointType.js").EndpointType.Empty> | undefined;
}
