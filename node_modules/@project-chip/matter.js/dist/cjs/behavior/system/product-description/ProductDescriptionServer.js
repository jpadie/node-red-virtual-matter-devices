...
var import_BridgedNodeEndpoint = require("../../../endpoint/definitions/system/BridgedNodeEndpoint.js");
...
var import_DescriptorBehavior = require("../../definitions/descriptor/DescriptorBehavior.js");
/**
 * @license
...
((ProductDescriptionServer2) => {
  ProductDescriptionServer2.UNKNOWN_DEVICE_TYPE = (0, import_DeviceTypeId.DeviceTypeId)(-1, false);
  class State {
    /**
     ...
     */
    vendorId = (0, import_VendorId.VendorId)(-1, false);
    /**
...
function inferDeviceType(agent) {
  ...
  for (const dt of agent.get(import_DescriptorBehavior.DescriptorBehavior).state.deviceTypeList) {
    switch (dt.deviceType) {
      case import_RootEndpoint.RootEndpoint.deviceType:
      case import_BridgedNodeEndpoint.BridgedNodeEndpoint.deviceType:
      case import_AggregatorEndpoint.AggregatorEndpoint.deviceType:
        recurse = true;
        break;
      default:
        if (agent.endpoint.type.deviceClass === import_DeviceTypes.DeviceClasses.Simple) {
