 ...
 */
const logger = import_Logger.Logger.get("ValidatedElements");
class ValidatedElements {
  ...
  report() {
    ...
    for (const error of this.errors) {
      const diagnostic = import_Diagnostic.Diagnostic.squash("Error in ", import_Diagnostic.Diagnostic.strong(error.element), ": ", error.message);
      if (error.fatal) {
        crashed = true;
