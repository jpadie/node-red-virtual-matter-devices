...
var import_ClusterComposer = require("../../cluster/mutation/ClusterComposer.js");
var import_ElementModifier = require("../../cluster/mutation/ElementModifier.js");
...
class ClusterBehavior extends import_Behavior.Behavior {
   ...
   */
  static cluster = import_ClusterType.ClusterType.Unknown;
  /**
   * Method definitions.
   */
  ...
  constructor(agent, backing) {
    ...
    if (!cluster) {
      throw new import_MatterError.ImplementationError("ClusterBehavior class has no cluster defined");
    }
  }
  /**
  ...
  static with(...features) {
    const newCluster = new import_ClusterComposer.ClusterComposer(this.cluster).compose(features);
  ...
  static alter(alterations) {
    return this.for(new import_ElementModifier.ElementModifier(this.cluster).alter(alterations));
  }
  /**
   ...
   */
  static enable(flags) {
    return this.for(new import_ElementModifier.ElementModifier(this.cluster).enable(flags));
  }
  /**
...
((ClusterBehavior2) => {
  class Events extends import_Observable.EventEmitter {
     ...
     */
    interactionBegin = (0, import_Observable.Observable)();
    /**
     * Emitted when a mutating interaction completes.
     */
    interactionEnd = (0, import_Observable.AsyncObservable)();
  }
