  ...
  switch (schema.effectiveMetatype) {
    ...
    case import_model.Metatype.boolean:
      return (value, _session, location) => {
        ...
        if (!constraint.test(value, location.siblings)) {
          throw new import_errors.ConstraintError(schema, location, `Value ${value} is disallowed by constraint`);
        }
      };
    ...
    default:
      throw new import_MatterError.InternalError(`Cannot define constraint for unsupported metatype ${schema.effectiveMetatype}`);
  }
}
