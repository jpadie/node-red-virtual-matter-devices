...
class Behavior {
  ...
  get session() {
    ...
    if (session === void 0) {
      throw new import_MatterError.ImplementationError(`Illegal operation outside session context`);
    }
   ...
   */
  static Events = import_Observable.EventEmitter;
  /**
  ...
  callback(reactor, options) {
    const observable = (0, import_Observable.Observable)();
