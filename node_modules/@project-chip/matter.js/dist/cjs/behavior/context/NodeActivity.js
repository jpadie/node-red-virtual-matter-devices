...
class NodeActivity {
  ...
  #active = (0, import_Observable.Observable)();
  #inactive = (0, import_Observable.Observable)();
  get isActive() {
  ...
  begin(description, onClose) {
    const elapsed = import_Diagnostic.Diagnostic.elapsed();
    const actor = {
      stack: [description],
      get elapsed() {
        return elapsed;
  ...
  get [import_Diagnostic.Diagnostic.value]() {
    if (!this.#actors.size) {
      return import_Diagnostic.Diagnostic.list([import_Diagnostic.Diagnostic.weak("none")]);
    }
    return import_Diagnostic.Diagnostic.list(this.actors);
  }
}
