...
var import_AccessControlServer = require("../../definitions/access-control/AccessControlServer.js");
...
function OnlineContext(options) {
  return {
    act(actor) {
      ...
      if (subject === void 0) {
        throw new import_MatterError.ImplementationError("OnlineContext requires an authorized subject");
      }
      const { message } = options;
      const via = import_Diagnostic.Diagnostic.via(
