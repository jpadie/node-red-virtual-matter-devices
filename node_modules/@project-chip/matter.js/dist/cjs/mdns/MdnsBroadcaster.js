...
class MdnsBroadcaster {
  ...
  #mdnsServer;
  #enableIpv4;
  #instances = new import_Set.BasicSet();
  ...
  #validateCommissioningData(data) {
    ...
    if (sessionIdleInterval !== void 0 && sessionIdleInterval > 36e5) {
      throw new import_MatterError.ImplementationError("Session Idle Interval must be less than 1 hour");
    }
    if (sessionActiveInterval !== void 0 && sessionActiveInterval > 36e5) {
      throw new import_MatterError.ImplementationError("Session Active Interval must be less than 1 hour");
    }
    if (sessionActiveThreshold !== void 0 && sessionActiveThreshold > 65535) {
      throw new import_MatterError.ImplementationError("Session Active Threshold must be less than 65535 seconds");
    }
  }
