...
var import_definitions = require("../model/definitions/index.js");
/**
 * @license
...
function* lex(text, error, keywords) {
  ...
  function tokenizeDigits(base, sign, valueOf) {
    ...
    if (peeked.value === "%") {
      next();
      return { type: "value", value: import_definitions.FieldValue.Percent(num), startLine, startChar };
    } else if (peeked.value === "\xB0") {
      next();
      if (peeked.value?.toLowerCase() === "C") {
        next();
      }
      return { type: "value", value: import_definitions.FieldValue.Celsius(num), startLine, startChar };
    }
